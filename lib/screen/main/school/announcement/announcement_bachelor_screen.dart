...
class AnnouncementBachelorScreen extends StatelessWidget {
  AnnouncementBachelorScreen({super.key});
  ...
  Future<Map?> getData() async {
    try {
      final data = await dio.get(
        'https://www.daelim.ac.kr/ajaxf/FrBoardSvc/BBSViewList.do?pageNo=1&MENU_ID=900&SITE_NO=2&BOARD_SEQ=8',
      );
