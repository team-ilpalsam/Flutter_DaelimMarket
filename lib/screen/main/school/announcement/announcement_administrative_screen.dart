...
class AnnouncementAdministrativeScreen extends StatelessWidget {
  AnnouncementAdministrativeScreen({super.key});
  ...
  Future<Map?> getData() async {
    try {
      final data = await dio.get(
        'https://www.daelim.ac.kr/ajaxf/FrBoardSvc/BBSViewList.do?pageNo=1&MENU_ID=30&SITE_NO=2&BOARD_SEQ=1',
      );
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () async {
                                          Uri url = Uri.parse(
                                              'https://www.daelim.ac.kr/cms/FrBoardCon/BoardView.do?MENU_ID=30&SITE_NO=2&BOARD_SEQ=1&BBS_SEQ=${data[index]['BBS_SEQ']}');
