...
class CafeteriaProfstaffScreen extends StatelessWidget {
  CafeteriaProfstaffScreen({super.key});
    ...
    try {
      ...
      if (dateData.data != null) {
        ...
        final menuData = await dio.get(
          'https://www.daelim.ac.kr/ajaxf/FrBistroSvc/BistroCarteInfo.do?pageNo=1&MENU_ID=1480&BISTRO_SEQ=2&START_DAY=$currentWeekMonday&END_DAY=$currentWeekFriday',
        );
