...
import 'package:daelim_market/controller/detail_image_index_controller.dart';
...
class DetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => DetailImageIndexController(1),
      child: Scaffold(
        body: SafeArea(
          child:
                              ...
                              Center(
                                child: Column(
                                  children: [
                                    Stack(
                                      children: [
                                        BlocBuilder<DetailImageIndexController,
                                            int>(
                                          ...
                                          child: Container(
                                            ...
                                            child: BlocBuilder<
                                              ...
                                              builder: (context, state) =>
                                                  Center(
                                                child: Text(
                                                  '$state / ${snapshot.data!['images'].length}',
                                                  style: TextStyle(
                                                      fontFamily: 'Pretendard',
                                                      fontSize: 16.sp,
                                                      fontWeight: bold,
